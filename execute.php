...
if(isset($message['text']))
{
  ...
  elseif(strpos($text, "/link") === 0 && strlen($text)>6 )
  {
	...
	$response = "Ecco il link di Hardware Guides Italia: $obj_desc\n$worldsym  $short";
...
function set_referral_URL($url){
	$referral = array("hwguidesita-21","hwguidesita-21","hwguidesita-21","hwguidesita-21");
	$random = mt_rand(0,3);
